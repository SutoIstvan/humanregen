...
<body>
    ...
    <script>
        ...
        //             const endTime = (dayOfWeek === 6) ? 12 :
        //             18; // Для субботы время до 12:00, для остальных дней до 18:00

        //             console.log(
        //             `End time for selected date: ${endTime}:00`); // Проверим, какое время окончания установлено
