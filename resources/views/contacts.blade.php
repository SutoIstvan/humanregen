    ...
    <div class="container d-flex justify-content-center">
        <div class="col-12 col-lg-10">
            <div class="row row-cols-1 row-cols-md-3">
                <div class="col  ">
                    <div class="text-center card mb-5 rounded-3 shadow-sm pt-4">
                        <div class="card-body">
                            <i class="fa-solid fa-envelope fa-2xl" style="color: #008288"></i>
                            <h2 class="alex-brush-regular mt-4" style="color: #008288; font-size: 38px;">Email:</h2>
                            <p>info@humanregen.hu</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col  ">
                    <div class="text-center card mb-5 rounded-3 shadow-sm pt-4">
                        <div class="card-body">
                            <i class="fa-solid fa-phone fa-2xl" style="color: #008288"></i>
                            <h2 class="alex-brush-regular mt-4" style="color: #008288; font-size: 38px;">Telefon:</h2>
                            <p>+36 30 39 677 67</p>
                        </div>
                    </div>
                </div>
                <div class="col  ">
                    <div class="text-center card mb-5 rounded-3 shadow-sm pt-4">
                        <div class="card-body">
                            <i class="fa-solid fa-location-dot fa-2xl" style="color: #008288"></i>
                            <h2 class="alex-brush-regular mt-4" style="color: #008288; font-size: 38px;">Cím:</h2>
                            <p>7030 Paks, Vasút utca 10.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="px-4 my-5 text-center ">
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2740.9546746208853!2d18.8517212!3d46.60789869999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47425c6b0503bd07%3A0x4426f920bc68de44!2sPaks%2C%20Vas%C3%BAt%20u.%2010%2C%207030%20Magyarorsz%C3%A1g!5e0!3m2!1shu!2sua!4v1731274488035!5m2!1shu!2sua"
    ...
    <div class="px-4 pt-5 my-5 text-center border-bottom" data-aos="fade-up">
        ...
        <div class="overflow-hidden custom-max-height">
            <div class="container px-5">
                <img src="{{ asset('assets/img/humanregensport2.png') }}"
